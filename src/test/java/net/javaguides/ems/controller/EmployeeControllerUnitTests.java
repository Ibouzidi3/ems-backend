...
public class EmployeeControllerUnitTests {
    ...
    public void getEmployeeTest() throws Exception{
        ...
        employeesList.add(EmployeeMapper.mapToEmployeeDto(Employee.builder().id(2L).firstName("Sam").lastName("Curran").email("sam@gmail.com").build()));
    ...
    public void getByIdEmployeeTest() throws Exception{
        // precondition
        given(employeeService.getEmployeeById(employee.getId())).willReturn(employeeDto);
    ...
    public void updateEmployeeTest() throws Exception{
        ...
        EmployeeDto updatedDto = EmployeeMapper.mapToEmployeeDto(employee);
        given(employeeService.updateEmployee(anyLong(), any(EmployeeDto.class))).willReturn(updatedDto);
